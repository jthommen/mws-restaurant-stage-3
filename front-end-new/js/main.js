...
renderRestaurants = (restaurants) => {
    ...
    const neighborhoods = [...new Set(restaurants.map(restaurant => restaurant.neighborhood))];
    const cuisines = [...new Set(restaurants.map(restaurant => restaurant.cuisine_type))];
